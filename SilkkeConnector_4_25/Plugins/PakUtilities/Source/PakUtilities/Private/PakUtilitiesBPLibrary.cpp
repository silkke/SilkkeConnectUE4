...
#include "PakUtilitiesBPLibrary.h"
#include "PakUtilities.h"

UPakUtilitiesBPLibrary::UPakUtilitiesBPLibrary(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{

}

UPakUtilitiesBPLibrary* UPakUtilitiesBPLibrary::MakeDownloader()
{
	return NewObject<UPakUtilitiesBPLibrary>();
}

UPakUtilitiesBPLibrary* UPakUtilitiesBPLibrary::DownloadFile(const FString& Url, FString SavePath)
{
	FileUrl = Url;
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UPakUtilitiesBPLibrary::OnReady);
	HttpRequest->OnRequestProgress().BindUObject(this, &UPakUtilitiesBPLibrary::OnProgress_Internal);
...
void UPakUtilitiesBPLibrary::OnReadyCheckFileExist(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful)
{
	RemoveFromRoot();
...
void UPakUtilitiesBPLibrary::OnReady(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful)
{
	RemoveFromRoot();
	Request->OnProcessRequestComplete().Unbind();
...
void UPakUtilitiesBPLibrary::OnProgress_Internal(FHttpRequestPtr Request, int32 BytesSent, int32 BytesReceived)
{
...
USkeletalMesh* UPakUtilitiesBPLibrary::SetSkeletalMeshSkeleton(USkeletalMesh* skeletalMesh, USkeleton* skeleton)
{
	skeletalMesh->Skeleton = skeleton;
	return skeletalMesh;
}

bool UPakUtilitiesBPLibrary::IsEditor()
{
#if WITH_EDITOR
	return true;
#else
...
TArray<FString> UPakUtilitiesBPLibrary::GetAllPakFiles(const FString& Directory, const FString& FileExtension)
{
...
void UPakUtilitiesBPLibrary::GetAvatarFilesInFolder(const FString& Directory, const FString& avatarID, USkeletalMesh*& skeletalMesh, UTexture2D*& texture2D)
{
...
void UPakUtilitiesBPLibrary::DeleteFilesInFolder(const FString& Directory)
{
	TArray<FString> FoundedFiles;
...
FString UPakUtilitiesBPLibrary::GetAbsoluteProjectPath()
{
	return FPaths::ConvertRelativePathToFull(FPaths::ProjectDir());
}

void UPakUtilitiesBPLibrary::MountPakAndStartAssetLoading(const FString& avatarID, const FString& PakFolder, const FString& PakName, const FString& MountPoint, TArray<UObject*>& Classes)
{
