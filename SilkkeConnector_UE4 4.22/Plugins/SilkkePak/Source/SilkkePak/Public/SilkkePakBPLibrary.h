...
#include "SilkkePakBPLibrary.generated.h"
...
UCLASS()
class USilkkePakBPLibrary : public UBlueprintFunctionLibrary
{
	...
	static USilkkePakBPLibrary* MakeDownloader();

	UFUNCTION(BlueprintCallable, Category = "HTTP")
	USilkkePakBPLibrary* DownloadFile(const FString& Url, FString SavePath);
